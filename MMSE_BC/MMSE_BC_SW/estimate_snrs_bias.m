...
% a-posteriori SNR, (4)
a_post_snr_bias = noisy_dft_frame_p./(noise_psd(1:fft_size/2+1));
...
if I==1
    ...
    %       =========================
    a_priori_snr_bias = max( ALPHA*( clean_est_dft_frame_p(1:fft_size/2+1))./...
        ( noise_psd(1:fft_size/2+1)) + (1-ALPHA)*(a_post_snr_bias-1), SNR_LOW_LIM );
end